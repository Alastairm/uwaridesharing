...
export async function SpatulaVendible() {
  const slug = slugURI;
...
export async function SpatulaSubmit(vendible, location, user) {
...
export async function SpatulaConfirm(token, stripe) {
...
export async function SpatulaUser() {
...
export async function SpatulaEndpointLocation() {
...
export async function getVendible() {
